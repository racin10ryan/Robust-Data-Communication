...
class rxr(gr.top_block, Qt.QWidget):

    def __init__(self, freq=920e6, rxBB=0, rxIF=0, rxThresh=.915, samp_rate=2e6):
        ...
        self.settings = Qt.QSettings("GNU Radio", "rxr")
        ...
        self.connect((self.osmosdr_source_0_1_0, 0), (self.qtgui_freq_sink_x_0_0, 0))
...
def argument_parser():
    ...
    parser.add_argument(
        "--freq", dest="freq", type=eng_float, default=eng_notation.num_to_str(float(920e6)),
...
def main(top_block_cls=rxr, options=None):
    if options is None:
