...
class txr1(gr.top_block):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.transmit_divider = transmit_divider = 1/4
        self.samp_rate = samp_rate = 2e6
        self.payload_chosen_constellation = payload_chosen_constellation = digital.constellation_bpsk().base()
        self.freq = freq = 2.45e9
        self.file = file = "/home/ryan/Documents/Tests/input.txt"

        ##################################################
        # Blocks
        ##################################################
        self.xmlrpc_server_0 = SimpleXMLRPCServer(('localhost', 1234), allow_none=True)
