...
class rd2zmq(gr.top_block, Qt.QWidget):

    def __init__(self, freq=915e6, rxBB=0, rxIF=0, samp_rate=2e6):
        gr.top_block.__init__(self, "rd2zmq", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("rd2zmq")
        ...
        self.settings = Qt.QSettings("GNU Radio", "rd2zmq")
        ...
        # Blocks
        ##################################################
        self.zeromq_pub_sink_0 = zeromq.pub_sink(gr.sizeof_gr_complex, 1, 'tcp://127.0.0.1:1235', 100, False, -1, "")
        self.xmlrpc_server_0 = SimpleXMLRPCServer(('localhost', 8005), allow_none=True)
        ...
        self.osmosdr_source_0_1.set_gain(0, 0)
...
def main(top_block_cls=rd2zmq, options=None):
    if options is None:
