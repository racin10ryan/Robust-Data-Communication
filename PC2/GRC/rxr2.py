...
class rxr2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, freq=5.8e9, rxBB=15, rxIF=40, samp_rate=2e6):
        ...
        self.osmosdr_source_0_1.set_sample_rate(8e6)
        ...
        self.osmosdr_source_0_1.set_bandwidth(2e6, 0)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/media/ryan/New Volume/Senior Design/Working On/received.ddi', False)
        ...
        self.connect((self.deconstruct_packets_new_0, 1), (self.qtgui_time_sink_x_0_2, 0))
        self.connect((self.osmosdr_source_0_1, 0), (self.qtgui_freq_sink_x_0_0, 0))
        self.connect((self.osmosdr_source_0_1, 0), (self.qtgui_time_sink_x_0_2_0, 0))
        self.connect((self.osmosdr_source_0_1, 0), (self.rational_resampler_xxx_0, 0))
        self.connect((self.rational_resampler_xxx_0, 0), (self.blocks_copy_0, 0))
