...
class rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, freq=908e6, rxBB=0, rxIF=0, rxThresh=0.915, samp_rate=2e6):
        ...
        self.osmosdr_source_0_1_0 = osmosdr.source(
            args="numchan=" + str(1) + " " + ''
        )
        self.osmosdr_source_0_1_0.set_time_now(osmosdr.time_spec_t(time.time()), osmosdr.ALL_MBOARDS)
        self.osmosdr_source_0_1_0.set_sample_rate(samp_rate)
        self.osmosdr_source_0_1_0.set_center_freq(freq, 0)
        self.osmosdr_source_0_1_0.set_freq_corr(0, 0)
        self.osmosdr_source_0_1_0.set_dc_offset_mode(0, 0)
        self.osmosdr_source_0_1_0.set_iq_balance_mode(0, 0)
        self.osmosdr_source_0_1_0.set_gain_mode(False, 0)
        self.osmosdr_source_0_1_0.set_gain(0, 0)
        self.osmosdr_source_0_1_0.set_if_gain(rxIF, 0)
        self.osmosdr_source_0_1_0.set_bb_gain(rxBB, 0)
        self.osmosdr_source_0_1_0.set_antenna('', 0)
        self.osmosdr_source_0_1_0.set_bandwidth(2e6, 0)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/media/ryan/New Volume/Senior Design/Working On/PC2/Received/received.ddi', False)
        ...
        self.connect((self.osmosdr_source_0_1_0, 0), (self.blocks_copy_0, 0))
    ...
    def set_freq(self, freq):
        self.freq = freq
        self.osmosdr_source_0_1_0.set_center_freq(self.freq, 0)
    ...
    def set_rxBB(self, rxBB):
        self.rxBB = rxBB
        self.osmosdr_source_0_1_0.set_bb_gain(self.rxBB, 0)
    ...
    def set_rxIF(self, rxIF):
        self.rxIF = rxIF
        self.osmosdr_source_0_1_0.set_if_gain(self.rxIF, 0)

    def get_rxThresh(self):
        return self.rxThresh

    def set_rxThresh(self, rxThresh):
        self.rxThresh = rxThresh
        self.deconstruct_packets_new_0.set_thresh(self.rxThresh)
...
def argument_parser():
    ...
    parser.add_argument(
        "--freq", dest="freq", type=eng_float, default=eng_notation.num_to_str(float(908e6)),
...
def main(top_block_cls=rx, options=None):
    ...
    tb = top_block_cls(freq=options.freq, rxBB=options.rxBB, rxIF=options.rxIF, rxThresh=options.rxThresh, samp_rate=options.samp_rate)
