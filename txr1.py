...
class txr1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, freq=5.8e9, samp_rate=2e6, transmit_divider=1/38):
    ...
    def get_freq(self):
        return self.osmosdr_sink_0_1.get_center_freq()

    def set_freq(self, freq):
        self.freq = freq
        self.osmosdr_sink_0_1.set_center_freq(freq)
...
def argument_parser():
    ...
    parser.add_argument(
        "--transmit-divider", dest="transmit_divider", type=eng_float, default=eng_notation.num_to_str(float(1/38)),
