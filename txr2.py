...
class txr2(gr.top_block, Qt.QWidget):
    ...
    def set_freq(self, freq):
        self.freq = freq
        #Uncomment if this is radio 1's file
        #radio='hackrf=0000000000000000f77c60dc235e53c3'
        #uncomment if this is radio 2's file
        radio='hackrf=0000000000000000088869dc294cae1b'

        self.disconnect((self.blocks_multiply_const_vxx_0_0, 0), (self.osmosdr_sink_0_1, 0))

        self.osmosdr_sink_0_1 = osmosdr.sink(
            args="numchan=" + str(1) + " " + radio
        )
        self.osmosdr_sink_0_1.set_time_now(osmosdr.time_spec_t(time.time()), osmosdr.ALL_MBOARDS)
