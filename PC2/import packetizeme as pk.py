...
requestlist=packetizeme.depacketize('/media/ryan/New Volume/Senior Design/Working On/PC2/Received/received.ddi','/media/ryan/New Volume/Senior Design/Working On/PC2/Received/input.txt')
print(requestlist)
print((str(os.getcwd())))
